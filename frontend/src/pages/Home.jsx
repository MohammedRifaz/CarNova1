...
export default function Home() {
  ...
  const handleViewMore = () => setVisibleCount((p) => p + 6);
  ...
  return (
    <>
      ...
      <div
        ...
        style={{
          backgroundImage: "url('https://4kwallpapers.com/images/walls/thumbs_3t/4140.jpg')",
        }}
      >
        ...
        <div className="relative z-10 flex flex-col items-center justify-center h-full text-center px-4">
          ...
          <button
            ...
            className="bg-yellow-500 text-white px-8 py-3 rounded-full font-semibold hover:brightness-110 transition"
          >
            Explore Inventory
          </button>
        </div>
